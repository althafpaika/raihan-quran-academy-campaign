...
export function App(props) {
  ...
  // const [Class, setClass] = useState("lakds");
  ...
  function draw() {
    if (BgLoadStatus && CroppedImgStatus) {
      ...
      _ctx.font = "bold 100px sans-serif";
      ...
      _ctx.fillText(_name, Cropx + CropW / 2, Cropy + CropH + 110);
    ...
    <>
      ...
      <div className="Cont">
        ...
        <div className="Actions">
          {GeneratedData ? (
            <div>
              <a href={GeneratedData} download="RAIHAN ONLINE QURAN ACADEMY campaign poster">
                <button>
            ...
            <div className="flex-column">
              ...
              <button
                onClick={() => {
                  if(!Name){
                    window.alert('First Enter Your Name')
                    return
                  }
                  file.click();
                }}
